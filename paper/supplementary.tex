...
FoldFlow LM parameters & 50,189,312 (50.2M) \\
...
\todo{Add CIFAR-100 baseline vs. full model results when experiment
completes.}
...
WikiText-2 param-matched (15 ep, 2 seeds) & 1 model & $\sim$6 hours \\
CIFAR-100 (50 ep, 3 seeds)            & 2 configs & \todo{TBD} \\
\midrule
\textbf{Total} & & $\sim$\textbf{43 hours} \\
\bottomrule
\end{tabular}
\end{table}
